    ...
    <div className="container-tight py-16 md:py-24">
      ...
      >
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-foreground/70">
            We help organisations build capability through blended learning:
            online, in the flow of work, and in-person experiences that stick.
          </p>
        </div>
      </motion.section>
      ...
      >
        <div className="rounded-2xl border bg-white p-8">
          ...
          <p className="mt-3 text-foreground/70">
            To close the capability gap by delivering measurable, scalable
            learning that creates real performance outcomes.
          </p>
        ...
        <div className="rounded-2xl border bg-white p-8">
          ...
          <p className="mt-3 text-foreground/70">
            We blend digital, live and coaching experiences into modular
            programs tailored to your context.
          </p>
          <div className="mt-6 grid grid-cols-2 gap-4">
            <div className="rounded-lg border p-4">
              <h4 className="font-semibold">Design</h4>
              <p className="text-sm text-foreground/70">
                Human-centred course design and micro-learning.
              </p>
            </div>
            <div className="rounded-lg border p-4">
              <h4 className="font-semibold">Delivery</h4>
              <p className="text-sm text-foreground/70">
                Live workshops, coaching and in-flow learning.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <p className="mt-3 text-center text-foreground/70">
          Experienced leaders in learning, product and people development.
        </p>
      ...
      <motion.section
        className="mt-16 rounded-2xl border bg-white p-8 text-center"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        viewport={{ once: true }}
        transition={{ duration: 0.6 }}
      >
        <h3 className="heading-2">
          We partner with organisations to build capability
        </h3>
        <p className="mt-3 text-foreground/70">
          Get in touch to discuss how we can support your learning agenda.
        </p>
