...
const testimonials = [
  {
    ...
    name: "Alex Janssen",
    role: "HR Director, Global Org",
    image: "/girl-donethumbs.jpg",
  },
  {
    quote:
      "“The sessions were practical and engaging. Our team is now more confident and productive.”",
    name: "Priya Singh",
    role: "Learning Manager, FinTech Inc.",
    image: "/man-showing-thumb.jpg",
  },
  {
    quote:
      "“Upskilling with this platform has transformed how we approach leadership development.”",
    name: "Mark Thompson",
    role: "People Lead, Retail Co.",
    image: "/girl-donethumbs.jpg",
  },
  {
    quote:
      "“An innovative approach that blends live and digital learning beautifully.”",
    name: "Elena García",
    role: "Head of Talent, TechCorp",
    image: "/man-showing-thumb.jpg",
  },
  {
    quote: "“Our employees are happier and more engaged than ever before.”",
    name: "John Chen",
    role: "Director of HR, Manufacturing Ltd.",
    image: "/girl-donethumbs.jpg",
  },
];
...
export default function Testimonials() {
  ...
  return (
    <section className="container-tight py-16 md:py-24 overflow-hidden">
      {/* <section className="py-12 bg-gray-50 sm:py-16 lg:py-20"> */}
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          <div className="text-center">
            <p className="text-lg font-medium text-gray-600 font-pj">
              10 thousand plus people have said how good Rareblocks
            </p>
