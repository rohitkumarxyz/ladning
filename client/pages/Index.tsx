  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b">
        <div
          className="absolute -top-28 -right-20 h-[420px] w-[420px] rounded-full bg-primary/40 blur-3xl"
          aria-hidden="true"
        />
        <div className="container-tight grid gap-10 py-16 md:grid-cols-2 md:gap-14 md:py-24">
          <div className="relative z-10">
            ...
            <h1 className="heading-hero mt-4">
              Power skills training that drives measurable performance
            </h1>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
              <Button
                size="lg"
                className="rounded-full text-base px-6 btn-anim"
              >
                Request demo
              </Button>
              <a
                href="#programs"
                className="text-sm font-semibold underline underline-offset-4 sm:ml-2"
              >
                Explore programs
              </a>
            </div>
          ...
          <div className="relative">
            <div
              className="absolute -left-16 -top-10 h-24 w-24 rounded-full bg-primary/60 blur-2xl"
              aria-hidden="true"
            />
              ...
              <div className="relative rounded-2xl border bg-white p-4 shadow-xl">
                ...
                <div className="mt-4 rounded-xl border p-4">
                  ...
                  <p className="mt-1 text-sm text-foreground/70">
                    A practical path to confident leadership across your
                    organization.
                  </p>
                </div>
              </div>
      ...
      <section id="solutions" className="container-tight py-16 md:py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-3 text-foreground/70">
            From first-time managers to seasoned leaders, we develop the skills
            that matter most.
          </p>
        </div>
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <div
              key={c.title}
              className="group relative overflow-hidden rounded-2xl border bg-white p-6 transition-shadow hover:shadow-lg card-anim"
            >
              <div
                className="absolute -right-8 -top-8 h-24 w-24 rounded-full bg-primary/30 blur-xl transition-transform group-hover:translate-x-2"
                aria-hidden="true"
              />
      ...
      >
        <div
          className="absolute -left-24 -top-24 h-64 w-64 rounded-full bg-primary blur-3xl opacity-90"
          aria-hidden="true"
        />
          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mt-3 max-w-lg text-white/80">
                ...
                learning in the flow of work to create lasting behavior change.
              </p>
              <div className="mt-8 grid grid-cols-3 gap-6 text-center">
                ...
                <div>
                  ...
                  <span className="text-white/80"> apply skills</span>
                </div>
                <div>
                  <span className="block text-4xl font-extrabold text-primary">
                    NPS 70
                  </span>
                  <span className="text-white/80"> learners love it</span>
                </div>
              </div>
            </div>
            <div className="relative">
        ...
        <div className="flex items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-2 text-foreground/70">
              Modular, stackable and tailored to your context.
            </p>
          </div>
          <a
            href="#"
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            },
            {
              ...
              desc: "Clarity, influence and impact in every message.",
            },
            {
              title: "High-Performance Habits",
              desc: "Focus, prioritization and execution that sticks.",
            },
          ].map((p) => (
            <article
              key={p.title}
              className="group rounded-2xl border bg-white p-6 transition-shadow hover:shadow-lg card-anim"
            >
      ...
      <section className="container-tight py-16 md:py-24">
        <div className="rounded-2xl border bg-white p-8 md:p-12">
          <p className="text-lg md:text-xl font-semibold max-w-4xl">
            “With Lepaya, our managers quickly developed the capabilities to
            lead with clarity, coach effectively and drive team performance.”
          </p>
      ...
      <section id="resources" className="container-tight py-16 md:py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-2 text-foreground/70">
            Expert guidance on capability building and organizational
            performance.
          </p>
        </div>
          ...
          {Array.from({ length: 3 }).map((_, i) => (
            <article key={i} className="rounded-2xl border bg-white p-6">
              ...
              <h3 className="mt-4 text-lg font-semibold">
                How to scale leadership capabilities
              </h3>
              <p className="mt-2 text-sm text-foreground/70">
                A practical playbook for building high-performing managers in
                months.
              </p>
              <a
                href="#"
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container-tight">
          <div className="relative isolate overflow-hidden rounded-2xl border bg-white p-8 md:p-12">
            <h3 className="heading-2 max-w-2xl">
              Ready to power up your people?
            </h3>
            <p className="mt-2 max-w-2xl text-foreground/70">
              See how Lepaya can deliver measurable impact for your
              organization.
            </p>
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <Button size="lg" className="rounded-full btn-anim">
                Request demo
              </Button>
              <a
                href="#contact"
                className="sm:ml-2 inline-flex items-center text-sm font-semibold underline underline-offset-4"
              >
                Contact us
              </a>
            </div>
